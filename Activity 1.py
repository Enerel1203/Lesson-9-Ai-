...
rec1_width, rec1_height= 150, 150
top_left1 = (20, 20)
...
cv2.putText(image_rgb, 'Center 1', (center1_x - 40, center1_y + 40), font, 0.5, (255, 255, 0), 1, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (center2_x - 40, center2_y + 40), font, 0.5, (255, 255, 0), 1, cv2.LINE_AA)

arrow_start= (width - 50, 20)
arrow_end = (width - 50, height - 20)

cv2.arrowedLine(image_rgb, arrow_start, arrow_end, (255, 0, 0), 3, tipLength= 0.05)
cv2.arrowedLine(image_rgb, arrow_end, arrow_start, (255, 0, 0), 3, tipLength= 0.05)

height_label_position = (arrow_start[0] - 150, (arrow_start[1] + arrow_end[1]) // 2)
cv2.putText(image_rgb, f'Height: {height}px', height_label_position, font, 0.5, (255, 0, 0), 1, cv2.LINE_AA)
